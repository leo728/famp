...
CREATE TABLE `raw_authorize` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='权限控制菜单表';

-- ----------------------------
-- Records of raw_authorize
-- ----------------------------
INSERT INTO `raw_authorize` VALUES ('1', '0', '首页概述', 'index/index', 'am-icon-dashboard', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('2', '0', '项目管理', 'index/projects', 'am-icon-tasks', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('3', '2', '项目列表', 'index/projects/index', 'am-icon-tasks', '1', '1', '0', '1');
INSERT INTO `raw_authorize` VALUES ('4', '2', '项目报表', 'index/projects/report', 'am-icon-bar-chart', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('5', '0', '财务管理', 'index/finance', 'am-icon-paypal', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('6', '5', '收支记录', 'index/finance/index', 'am-icon-list-ul', '1', '1', '5', '1');
INSERT INTO `raw_authorize` VALUES ('7', '5', '工时管理', 'index/finance/man_hour', 'am-icon-coffee', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('8', '5', '资金流', 'index/finance/management', 'am-icon-btc', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('9', '5', '财务报表', 'index/finance/statements', 'am-icon-bar-chart', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('10', '0', '部门管理', 'index/member', 'am-icon-graduation-cap', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('12', '0', '报价管理', 'index/quoted', 'am-icon-rocket', '1', '1', '0', '1');
INSERT INTO `raw_authorize` VALUES ('13', '0', '文档管理', 'index/documents', 'am-icon-folder-open-o', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('14', '0', '权限管理', 'index/authorize', 'am-icon-sliders', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('15', '0', '全局设置', 'index/settings', 'am-icon-cogs', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('16', '14', '权限菜单', 'index/authorize/index', 'am-icon-bars', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('17', '14', '管理组', 'index/authorize/groups', 'am-icon-users', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('18', '14', '管理日志', 'index/authorize/m_logs', 'am-icon-file-text-o', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('19', '10', '部门设置', 'index/member/department', 'am-icon-home', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('20', '10', '员工列表', 'index/member/index', 'am-icon-list', '1', '1', '1', '1');
INSERT INTO `raw_authorize` VALUES ('21', '5', '工资表', 'index/finance/wages', 'am-icon-table', '1', '1', '3', '1');
INSERT INTO `raw_authorize` VALUES ('22', '12', '报价列表', 'index/quoted/index', 'am-icon-list', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('23', '12', '新建报价', 'index/quoted/create_item', 'am-icon-plus', '1', '0', '0', '1');
INSERT INTO `raw_authorize` VALUES ('24', '12', '产品报价', 'index/quoted/products', 'am-icon-th-large', '1', '0', '0', '1');
...
CREATE TABLE `raw_authorize_map` (
  ...
  PRIMARY KEY (`map_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限控制map';
...
-- ----------------------------
INSERT INTO `raw_member` VALUES ('1', '1qtHmKEn7VmE9645', 'admin', '17787937708', 'c1e00a7504e6ce17dbc111ba4679e75c9faac99e', null, 'ig4XTRX2hbke7900', '8', '1473672824', '127.0.0.1', '1552147900', '::1', '1');
...
CREATE TABLE `raw_working_hours` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工时记录表';
